  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-500">
        Monthly studio usage fees owed by instructors
      </p>

      {/* Info banner */}
      <div className="mt-4 rounded-lg border border-blue-200 bg-blue-50 p-3">
        <p className="text-sm text-blue-700">
          This report shows what each instructor owes for studio usage.
          Settlement is handled outside the app (bank transfer, cash, etc.).
        </p>
      </div>
            ...
            {report.length > 0 ? (
              ...
              <div className="card py-8 text-center">
                <p className="text-sm text-gray-500">
                  No instructors with rental agreements, or no fees due this
                  month.
                </p>
                <p className="mt-2 text-xs text-gray-400">
                  Set up rental terms on each instructor&apos;s edit page.
                </p>
              </div>
            )}
          </div>
