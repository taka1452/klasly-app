...
export default function OwnerNewClassPage() {
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Set up your class details and pricing. Members will be able to book
          and pay directly.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-400">
              Members pay this amount per class.
            </p>
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Link href="/my-classes" className="btn-secondary">
              Cancel
            </Link>
          </div>
        </form>
