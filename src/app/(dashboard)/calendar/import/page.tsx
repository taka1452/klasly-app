  ...
  if (planAccess && !planAccess.canCreate) {
    return (
      <div className="mx-auto max-w-3xl">
        <div className="mb-6">
          <Link href="/calendar" className="group inline-flex items-center gap-1 text-sm font-medium text-brand-600 transition-colors duration-150 hover:text-brand-700">
