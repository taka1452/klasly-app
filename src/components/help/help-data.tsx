    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: (
            <>
              Click <B>+ Add</B> on the <B>Schedule</B> page to open the Add Session dialog. Select an existing class, pick a date and time, and choose <B>Single</B> or <B>Weekly</B> repeat. Weekly sessions are also auto-generated by the system based on the class schedule.
            </>
          ),
        },
        {
