...
export default function AdminTicketDetail({
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/admin/support" className="text-sm text-slate-400 transition-colors duration-150 hover:text-white">
      ...
      <div className="rounded-lg border border-slate-700 bg-slate-800 p-6">
        ...
        <form onSubmit={handleAddComment} className="mt-4 border-t border-slate-700 pt-4">
          ...
          <button
            ...
            className="mt-2 rounded bg-brand-600 px-4 py-2 text-sm font-medium text-white transition-[transform,background-color] duration-150 ease-out hover:bg-brand-500 active:scale-[0.97] disabled:opacity-50 disabled:active:scale-100"
          >
