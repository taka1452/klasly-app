...
const adminNavItems = [
  { key: "sidebar.dashboard", href: "/admin" },
  { key: "sidebar.studios", href: "/admin/studios" },
  { key: "sidebar.billing", href: "/admin/billing" },
  { key: "sidebar.coupons", href: "/admin/coupons" },
  { key: "sidebar.metrics", href: "/admin/metrics" },
  { key: "sidebar.support", href: "/admin/support" },
  { key: "sidebar.logs", href: "/admin/logs" },
  { key: "sidebar.announcements", href: "/admin/announcements" },
  { key: "sidebar.settings", href: "/admin/settings" },
];
    ...
    <nav className="flex flex-1 flex-col space-y-1 px-3 py-4">
      {adminNavItems.map((item) => {
        ...
        return (
          ...
          >
            <span className="shrink-0">{navIcons[item.key] ?? null}</span>
            {t(item.key)}
          </Link>
        );
      })}
      ...
      >
        ...
        <div className="border-t border-slate-700 px-3 py-3">
          ...
          >
            ...
            {t("sidebar.switchToOwner")} →
          </Link>
        </div>
        <div className="mt-auto border-t border-slate-700 px-6 py-4">
          <p className="text-xs text-slate-500">{t("sidebar.systemAdmin")}</p>
        </div>
      </aside>
    </>
  );
