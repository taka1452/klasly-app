          ...
          <div className="mt-6 flex flex-col gap-3">
            {cta.href ? (
              <Link
                href={cta.href}
                onClick={onClose}
                className="inline-flex items-center justify-center rounded-lg bg-brand-600 px-6 py-3 text-sm font-medium text-white transition-[transform,color,background-color] duration-150 ease-out hover:bg-brand-700 active:scale-[0.97]"
              >
                {cta.label}
              </Link>
            ) : (
